...
- AD-031 · 2026-09-26 · Imagem da lista é `img/ofertas/{id}-small.webp` (hífen), igual ao nome que o robô grava; robô entrega WebP pronto (small 200 px, natural ≤ 1024 px) e o worker só copia com verificação · zero tradução de nome, zero processamento por padrão · underscore no S3 com tradução no worker
